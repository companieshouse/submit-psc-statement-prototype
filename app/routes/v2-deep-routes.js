...
router.get('/deep/v2/sign-in-email', function (req, res) {
  // Set URl
  res.render('deep/v2/sign-in-email', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/sign-in-email', function (req, res) {
...
if (req.session.data['signin-email'] === '') {
  ...
  res.redirect('/deep/v2/sign-in-password')
}
})


// ******* Sign in password validation ********************************
router.get('/deep/v2/sign-in-password', function (req, res) {
// Set URl
res.render('deep/v2/sign-in-password', {
  currentUrl: req.originalUrl
})
})

router.post('/deep/v2/sign-in-password', function (req, res) {
// Create empty array and set error variables to false
var errors = []
...
if (req.session.data['signin-password'] === '') {
  ...
  // User inputted value so move to next page
  res.redirect('/deep/v2/company-number')
}
})


// ******* company-number javascript *********************
router.get('/deep/v2/company-number', function (req, res) {
  // Set URl
  res.render('deep/v2/company-number', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/company-number', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  ...
  if (req.session.data['companyNumber'] === '') {
    ...
    res.render('deep/v2/company-number', {
      ...
      res.redirect('/deep/v2/confirm-company')
  }
})


// ******* confirm-company javascript **********************
router.get('/deep/v2/confirm-company', function (req, res) {
  // Set URl
  res.render('deep/v2/confirm-company', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/confirm-company', function (req, res) {
  if ((req.session.data['companyNumber'] == '22223333')) {
    // Super secure
    res.redirect('/deep/v2/super-secure')
  } else {
    res.redirect('/deep/v2/individual/psc-list')
  }
})


// ******* psc-type javascript ********************************
router.get('/deep/v2/psc-type', function (req, res) {
  // Set URl
  res.render('deep/v2/psc-type', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/psc-type', function (req, res) {
  var errors = []
  ...
  if (typeof req.session.data['pscType'] === 'undefined') {
    ...
    if ((req.session.data['pscType'] == 'PSC')) {
      ...
      res.redirect('/deep/v2/rle/rle-list')
    }
  }
})
...
// ******* rle-list javascript ********************************
router.get('/deep/v2/rle/rle-list', function (req, res) {
  res.render('deep/v2/rle/rle-list', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/rle/rle-list', function (req, res) {
  var errors = []
  ...
  if (typeof req.session.data['rleList'] === 'undefined') {
    ...
    res.render('deep/v2/rle/rle-list', {
      ...
      res.redirect('/deep/v2/rle/ro-details')
    }
})

// ******* ro-details javascript *********************
router.get('/deep/v2/rle/ro-details', function (req, res) {
  // Set URl
  res.render('deep/v2/rle/ro-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/rle/ro-details', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  ...
  res.render('deep/v2/rle/ro-details', {
    ...
    if (req.session.data['roPersonalCode'] === '111-2222-3333') {
      res.redirect('/deep/v2/rle/ro-why-this-name')
    } 
    // dob code mis-match
      ...
      res.redirect('/deep/v2/rle/ro-statements')
    }
  }
})
...
router.get('/deep/v2/rle/ro-why-this-name', function (req, res) {
  // Set URl
  res.render('deep/v2/rle/ro-why-this-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/rle/ro-why-this-name', function (req, res) {
  res.redirect('/deep/v2/rle/ro-statements')
})


// ******* ro-statements javascript ********************************
router.get('/deep/v2/rle/ro-statements', function (req, res) {
  // Set URl
  res.render('deep/v2/rle/ro-statements', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/rle/ro-statements', function (req, res) {
  var errors = [];
  ...
  if (typeof req.session.data['rleStatementOne'] === 'undefined' || 
    ...
    res.redirect('/deep/v2/rle/rle-verified')
  }
})
...
// ******* psc-list javascript ********************************
router.get('/deep/v2/individual/psc-list', function (req, res) {
  res.render('deep/v2/individual/psc-list', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/individual/psc-list', function (req, res) {
  var errors = []
  ...
  if (typeof req.session.data['pscList'] === 'undefined') {
    ...
    res.render('deep/v2/individual/psc-list', {
      ...
      res.redirect('/deep/v2/individual/psc-details')
    }
})

// ******* psc-details javascript *********************
router.get('/deep/v2/individual/psc-details', function (req, res) {
  // Set URl
  res.render('deep/v2/individual/psc-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/individual/psc-details', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  ...
  res.render('deep/v2/individual/psc-details', {
    ...
    if (req.session.data['pscPersonalCode'] === '111-2222-3333') {
      res.redirect('/deep/v2/individual/psc-why-this-name')
    } 
    // dob code mis-match
    else if (req.session.data['pscPersonalCode'] === '444-5555-6666') {
      res.redirect('/deep/v2/individual/psc-dob-mismatch')
    } 
    else {
      res.redirect('/deep/v2/individual/psc-statement')
    }
  }
})
...
router.get('/deep/v2/individual/personal-code', function (req, res) {
  // Set URl
  res.render('deep/v2/individual/personal-code', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/individual/personal-code', function (req, res) {
// Create empty array and set error variables to false
var errors = []
...
if (req.session.data['personalCode'] === '') {
  ...
  res.render('deep/v2/individual/personal-code', {
    ...
    if (req.session.data['personalCode'] === '111-2222-3333') {
      ...
      res.redirect('/deep/v2/individual/non-match')
    } else if (req.session.data['personalCode'] === 'aaa-bbbb-cccc') {
      res.redirect('/deep/v2/too-many-attempts')
    } else {
      res.redirect('/deep/v2/individual/psc-statement')
    }
  }
...
router.get('/deep/v2/individual/psc-why-this-name', function (req, res) {
  // Set URl
  res.render('deep/v2/individual/psc-why-this-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/individual/psc-why-this-name', function (req, res) {
  res.redirect('/deep/v2/individual/psc-statement')
})
...
router.get('/deep/v2/individual/psc-statement', function (req, res) {
  // Set URl
  res.render('deep/v2/individual/psc-statement', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/individual/psc-statement', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['individualStatement'] === 'undefined') {
    ...
    res.render('deep/v2/individual/psc-statement', {
      ...
      res.redirect('/deep/v2/individual/psc-verified')
  }
})

// ******* extension relationship javascript ********************************
router.get('/deep/v2/extensions/extension-relationship', function (req, res) {
  // Set URl
  res.render('deep/v2/extensions/extension-relationship', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/extensions/extension-relationship', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['extRelationship'] === 'undefined') {
    ...
    res.redirect('/deep/v2/extensions/extension-reason')
  }
})


// ******* extension reason javascript ********************************
router.get('/deep/v2/extensions/extension-reason', function (req, res) {
  // Set URl
  res.render('deep/v2/extensions/extension-reason', {
    currentUrl: req.originalUrl
  })
})

router.post('/deep/v2/extensions/extension-reason', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['extReason'] === 'undefined') {
    ...
    res.redirect('/deep/v2/extensions/extension-confirmation')
  }
})
